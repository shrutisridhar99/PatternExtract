...
def run_qupath_mac(base_dir, mask_dir, qupath_path, project_dir):
    try:
        ...
        # qupath_path is the full path to the QuPath binary
...
st.markdown('<p class="subtitle">Automated Spatial Point Pattern Generation Pipeline</p>', unsafe_allow_html=True)
