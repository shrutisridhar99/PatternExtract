...
// Derive project directory from mask directory passed as args[0]
// args[0] = mask_dir (e.g. /path/to/PatternExtract/data/Mask)
// Project goes in /path/to/PatternExtract/Project/ki67
File maskDir   = new File(args[0])
File baseDir   = maskDir.getParentFile().getParentFile()
File directory = new File(baseDir, "Project/ki67")

if (!directory.exists()) {
    println "No project directory found — creating one at: ${directory}"
    directory.mkdirs()
}
