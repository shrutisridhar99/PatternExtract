...
// Define export directory relative to project structure
def exportDirPath = args[0]  // args is a Groovy array containing arguments passed via --args
...
exportAllObjectsToGeoJson(new File(exportDir, name + ".geojson").toString(),"EXCLUDE_MEASUREMENTS","PRETTY_JSON","FEATURE_COLLECTION")